...
namespace CMCS.DataTester
{
    public partial class MDIParent1 : Form
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnOpenYiBoLED_Click(object sender, EventArgs e)
        {
            new FrmLEDYiBo
            {
                MdiParent = this
        ...
        private void pCI控制卡ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new PCIIO { MdiParent = this }.Show();
        }

        private void 霍克威尔读卡器ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new FrmHawkvorRwer { MdiParent = this }.Show();
        }

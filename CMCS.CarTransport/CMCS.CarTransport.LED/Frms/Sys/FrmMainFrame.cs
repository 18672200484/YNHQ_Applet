...
using CMCS.CarTransport.LED.Utilities;
using CMCS.CarTransport.LED.Core;
using CMCS.Common.Enums;
using CMCS.CarTransport.LED.Frms;
...
namespace CMCS.CarTransport.LED.Frms.Sys
{
    public partial class FrmMainFrame : MetroForm
    {
        ...
        private void Form1_Shown(object sender, EventArgs e)
        {
            ...
            {
                SelfVars.LoginUser = new Common.Entities.iEAA.User();
                SelfVars.LoginUser.UserName = "系统管理员";
                SelfVars.LoginUser.UserAccount = "admin";
                //SelfVars.LoginUser = commonDAO.GetAdminUser();
            }
        ...
        {
            string uniqueKey = FrmLED.UniqueKey;
